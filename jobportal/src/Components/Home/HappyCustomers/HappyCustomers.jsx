        ...
        <div className="container">
            ...
            <div className="customer--container">
                ...
                modules={[ Pagination, Autoplay]}>
                    <SwiperSlide>
                        <div className="customer--block--slider">
                            <div className="grid space--between customer--block--inner">
                                <div className="flex space--start customer--block">
                                    <div className="customer--block--img">
                                        <img src={customerImg1} alt="" />
                                    </div>
                                    <div className="customer--title">
                                        <h4><strong>Jack</strong></h4>
                                ...
                                <div className="customer--rating">
                                    <svg
                                        ...
                                        height={24}
                                        viewBox="0 0 24 24"
                                        style={{ fill: "rgba(246, 81, 41, 1)", transform: "", msfilter: "" }}>
