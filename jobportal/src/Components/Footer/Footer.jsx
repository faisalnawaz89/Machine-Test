  ...
  return (
    <footer className='footer main--footer'>
        <div className="container">
            <div className="grid space--between footer--block">
                <div className="footer--title">
                    <img src={footer_logo} alt="" />
                    <ul>
                        <li>
                            <a href="#" className='flex space--start '>
                                <svg
        ...
        <div className="pre--footer--block">
            <div className="container">
                <div className="grid space--start pre--footer">
                    <div className="flex space--between copyright">
                        <p>Copyright © Gotto Job 2025</p>
                        <div className="flex copy--privacy">
