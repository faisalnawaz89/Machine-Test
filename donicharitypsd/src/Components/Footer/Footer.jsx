        ...
        <footer className='footer main-footer'>
            <div className="container">
                <div className="grid main--footer--content">
                    ...
                    <div className="footer-title">
                        <h4>NEWS</h4>
                        <p>generators on the Internet tend to repeat predefined chunks as necessary, making </p>
                    </div>
                    <div className="footer-title">
                        <h4>ADDRESS</h4>
                ...
                <div className="grid footer--social-newsletter">
                        ...
                        <ul>
                            <li>
                                ...
                                <svg
                                    ...
                                    height={24}
                                    viewBox="0 0 24 24"
                                    style={{ fill: "#868586", transform: "", msfilter: "" }}
                                    >
